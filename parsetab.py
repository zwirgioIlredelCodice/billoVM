...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','billolang.py',41),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','billolang.py',42),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','billolang.py',43),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','billolang.py',44),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','billolang.py',51),
  ('expression -> NUMBER','expression',1,'p_expression_number','billolang.py',55),
]
